...
pub use encoder::{
    ...
    encode_intra_picture_aic, encode_intra_picture_aic_auto, encode_intra_picture_dquant,
    encode_intra_picture_gobs, encode_intra_sequence, encode_pb_picture, encode_sequence,
