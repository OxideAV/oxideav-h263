...
pub use encoder::{
    ...
    encode_inter_picture_rru, encode_inter_picture_rru_umv, encode_inter_picture_sac,
    encode_inter_picture_slices, encode_inter_picture_slices_rect, encode_inter_picture_umv,
    encode_inter_picture_umv_plus, encode_inter_picture_umv_slices, encode_intra_picture,
