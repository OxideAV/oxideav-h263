...
pub use encoder::{
    ...
    encode_inter_picture_motion, encode_inter_picture_plus, encode_inter_picture_sac,
    encode_inter_picture_slices, encode_inter_picture_umv, encode_inter_picture_umv_plus,
